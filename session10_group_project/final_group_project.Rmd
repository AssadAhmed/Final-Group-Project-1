...
>>>>>>> 6af9f6223f79f8b9bc8f5cd2f8b1eb4b7ad00bcc
date: "`r Sys.Date()`"
output:
  html_document:
    theme: flatly
...
PackageList =c('tidyverse','tidymodels','GGally','sf','wbstats','data.table','countrycode', 'skimr', 'here','leaflet','janitor','rpart.plot','scales','vip','skimr','rsample','DataExplorer','gt','recipe','tictoc')
...
card_fraud <- recipe(is_fraud ~ ., data = card_fraud) %>%
  step_other(category, threshold = .03) %>% 
